...
<section class="section-berita py-5 bg-light">
    <div class="container-berita container">
        ...
        <form method="GET" action="{{ route('berita') }}"
            class="row gy-2 gx-3 align-items-center justify-content-center mb-5" data-aos="fade-up"
            data-aos-delay="100">
            ...
            <div class="col-6 col-sm-3 col-md-auto">
                <button type="submit"
                    class="btn btn-dark w-100 d-flex align-items-center justify-content-center gap-1 shadow-sm">
