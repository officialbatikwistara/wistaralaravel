            ...
            <div class="d-none d-md-block col-md-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('admin.kategori.index') }}"
                            class="text-white text-decoration-none d-block">Kategori</a></li>
                    <li><a href="{{ route('admin.produk.index') }}"
                            class="text-white text-decoration-none d-block">Produk</a></li>
                    <li><a href="{{ route('admin.berita.index') }}"
                            class="text-white text-decoration-none d-block">Berita</a></li>
                </ul>
            </div>
