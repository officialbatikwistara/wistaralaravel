...
<section class="hero-section d-flex justify-content-center align-items-center text-center text-light">
  ...
  <div class="hero-content">
    ...
    <h1>Selamat Datang di <span class="text-warning">Batik Wistara</span></h1>
    <p>Batik Wistara menghadirkan karya batik berkualitas tinggi, memadukan keindahan budaya dan sentuhan modern.</p>
    <a href="{{ url('/katalog') }}" class="btn btn-hero mt-3 px-4">Lihat Katalog</a>
  </div>
</section>
...
<section class="section-about py-5">
  <div class="container py-4">
    <div class="row align-items-center g-5 flex-column-reverse flex-lg-row">
      ...
      <!-- TEKS -->
      <div class="col-lg-6 about-textbox text-center text-lg-start">
...
<section class="section-berita py-5">
  <div class="container-berita">
    <!-- Judul -->
    <h2 class="berita-title text-center">Berita Terkini</h2>
        ...
        <div class="row g-4 align-items-start">
          ...
          <div class="col-md-7">
            ...
            <div class="d-flex gap-2 mb-3">
              <button class="btn btn-outline-dark flex-grow-1 fw-semibold">
                🛍️ Beli Sekarang
              </button>
